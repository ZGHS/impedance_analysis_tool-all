...
class AppNeg:
    ...
    def draw(self):
        ...
        for j in range(numFreqs):
            ...
            Vp = ImpedanceDataVariable_wf[j, 2]
            Ip = ImpedanceDataVariable_wf[j, 4]
            ...
            Impedance_WF[j, 1] = Ynp
            Impedance_WF[j, 2] = Ypn
            Impedance_WF[j, 3] = Ynn
        ...
        for j in range(numFreqs):
            ...
            Vp = ImpedanceDataVariable_zg[j, 2]
            Ip = ImpedanceDataVariable_zg[j, 4]
            ...
            Impedance_DW[j, 1] = Ynp
            Impedance_DW[j, 2] = Ypn
            Impedance_DW[j, 3] = Ynn
